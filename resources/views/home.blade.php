...
<section aside class= "card text-white bg-success mb-3" style="max-width: 100rem;">
<h3 class="text-black-20">SEJARAH KOTA KISARAN</h3>
    <P class="teks-putih">Kisaran adalah ibukota Kabupaten Asahan, Provinsi Sumatera Utara. 
    ...
    <P class="teks-putih">Kota Kisaran Timur, Kabupaten Asahan, provinsi Sumatera Utara, Indonesia. </P>
            </div>
